              ...
              <v-row>
                ...
                <v-col v-if="course.estado === true" cols="12" sm="6" md="4">
                  <v-text-field
                    ...
                    label="Inscritos"
                    required
                    hint="El curso ha terminado, no hay más inscripciones"
                  ></v-text-field>
                </v-col>
                <v-col v-else cols="12" sm="6" md="4">
                  <v-text-field
                    ...
                    label="Inscritos"
                    required
                    hint="La cantidad de inscritos no puede exceder los cupos disponibles"
                  ></v-text-field>
                </v-col>
        ...
        Firebase.firestore()
          ...
          .catch(() => {
            ...
            this.$swal.fire({
              icon: "error",
              title: "Oops...",
              text: `Algo anda mal, vuelve a intentarlo`,
            });
          });
      }
    },
